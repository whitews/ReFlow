...
urlpatterns = patterns('repository.api_views',
    ...
    url(r'^api/repository/compensations/(?P<pk>\d+)/npy/$', retrieve_compensation_as_numpy, name='retrieve_compensation_as_numpy'),    url(r'^api/repository/project_panels/$', ProjectPanelList.as_view(), name='project-panel-list'),
    ...
    url(r'^api/repository/samples/(?P<pk>\d+)/download/$', retrieve_sample, name='retrieve_sample'),
