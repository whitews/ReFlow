...
urlpatterns = patterns('repository.api_views',
    ...
    url(r'^api/repository/staining_classes/?$', StainingClassList.as_view(), name='staining-class-list'),
    url(r'^api/repository/staining_classes/(?P<pk>\d+)/?$', StainingClassDetail.as_view(), name='staining-class-detail'),
