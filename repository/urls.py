...
urlpatterns = patterns('repository.api_views',
    ...
    url(r'^api/repository/project_panels/?$', PanelTemplateList.as_view(), name='project-panel-list'),
    url(r'^api/repository/project_panels/(?P<pk>\d+)/?$', PanelTemplateDetail.as_view(), name='project-panel-detail'),
