...
urlpatterns = patterns('repository.api_views',
    ...
    url(r'^api/repository/samples/(?P<pk>\d+)/fcs/$', retrieve_sample, name='retrieve_sample'),
    url(r'^api/repository/samples/(?P<pk>\d+)/fcs_as_pk/$', retrieve_sample_as_pk, name='sample-download-as-pk'),
