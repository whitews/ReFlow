...
urlpatterns = patterns('repository.api_views',
    ...
    url(r'^api/repository/panels/$', SitePanelList.as_view(), name='panel-list'),
    url(r'^api/repository/panels/(?P<pk>\d+)/$', SitePanelDetail.as_view(), name='panel-detail'),
    url(r'^api/repository/parameters/$', ParameterList.as_view(), name='parameter-list'),
    url(r'^api/repository/parameters/(?P<pk>\d+)/$', ParameterDetail.as_view(), name='parameter-detail'),
    ...
    url(r'^api/repository/sample_groups/$', SampleGroupList.as_view(), name='sample-group-list'),
    ...
    url(r'^api/repository/samples/uncategorized/$', UncategorizedSampleList.as_view(), name='uncat-sample-list'),
    ...
    url(r'^api/repository/samples/(?P<pk>\d+)/add_compensation/$', SampleCompensationCreate.as_view(), name='sample-compensation-create'),
...
urlpatterns += patterns('repository.views',
    ...
    url(r'^site/panel/(?P<panel_id>\d+)/edit/$', 'edit_panel', name='edit_panel'),
